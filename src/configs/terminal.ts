export default {
  ...
  list: [
    ...
    {
      title: 'Gitmoji | 开Git 提交消息规范化工具',
      link: 'https://gitmoji.dev/',
      desc: 'Gitmoji 是一个 Git 提交消息规范化工具，引入了带有表情符号的提交消息格式（如 `:sparkles:` 代表新功能）。这种规范化使得提交历史更加清晰和易于理解。通过选择适当的表情符号，开发者可以快速传达提交的类型和目的，促进团队间的沟通和协作。强烈推荐在团队中使用这种方式，替代传统或者无规范提交。'
    },
    {
