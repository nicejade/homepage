export default {
  ...
  list: [
    ...
    {
      title: 'WorkAny | 你的 AI 工作伙伴',
      link: 'https://workany.ai/',
      desc: 'WorkAny 是一款开源的 桌面 AI 智能工作代理（AI Agent），让你通过自然语言描述便能在电脑上完成复杂任务，目标是把繁琐工作自动化，提高效率。它基于 AI 模型引擎和智能执行引擎构建，本地运行，数据不出电脑，大大增强隐私和安全性。主要功能包括： 智能整理文件、生成网站、生成文档与幻灯片、 自动生成表格、 它是一个让你 用自然语言指令驱动日常办公和开发任务 的 AI 助手。'
    },
    {
      title: 'PageIndex.ai | 模拟人类文档人工智能',
      link: 'https://pageindex.ai/',
      desc: '由 Vectify AI 公司推出的无向量、基于推理的 RAG 检索增强生成引擎。其核心创新在于模拟人类阅读方式，实现可追溯、可解释且上下文感知的文档检索，无需传统向量数据库或分块处理。该平台通过构建优化的页面索引树结构，让大语言模型像人类专家一样导航文档层次结构并提取信息。在 FinanceBench 基准测试中达到 98.7% 的准确率，显著优于传统向量数据库方案，特别适用于财务报告、法律文件、医疗记录、技术手册等需要高精度和可解释性的领域。'
    },
    {
