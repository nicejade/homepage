export default {
  ...
  list: [
    ...
    },
    {
      ...
      desc: 'Codex 是一款面向软件工程的 AI 编码助手/智能体，帮助开发者更快完成代码编写、重构、修复 bug 等工作。它由 OpenAI 最新的编码模型驱动，能够理解、编辑并在隔离的沙盒环境中运行代码，提升代码质量和团队效率。不只是写代码，Codex 还能自动化处理问题分流、测试、持续集成等日常工程任务，并可在 IDE、终端或独立应用中使用，适配不同工作流。'
    },
    {
    ...
    },
    {
      ...
      desc: 'Augment Code 是一款创新的 AI 驱动代码编辑器，专注于提供流畅的编码体验。它提供无限制的 AI 代码补全功能，支持实时代码建议和智能代码生成。独特之处在于其"流畅状态"设计理念，通过智能预测和上下文理解，让开发者保持连贯的编码节奏。提供免费的基础功能，包括代码补全、重构建议和 AI 辅助编程等特性。'
    },
    {
    ...
    {
      title: 'Kilo Code | Move at Kilo Speed',
      stars: 5,
      link: 'https://kilo.ai/',
      desc: 'Kilo Code 是一款为开发者设计的 AI 驱动开发平台，核心目标是让软件开发变得前所未有地快和智能。它提供无限制的 AI 代码补全功能，支持实时代码建议和智能代码生成。独特之处在于其"流畅状态"设计理念，通过智能预测和上下文理解，让开发者保持连贯的编码节奏。提供免费的基础功能，包括代码补全、重构建议和 AI 辅助编程等特性。'
    },
    {
    ...
    {
      title: 'Qoder - The Agentic Coding Platform',
      link: 'https://qoder.com/',
      desc: 'Qoder 是一款创新的代理式编码平台，旨在通过人工智能代理彻底革新软件开发流程。它将先进的 AI 代理与传统编码工具深度融合，帮助开发者从繁琐的代码编写中解放出来，实现高效、智能的编程体验。平台的核心功能包括：智能代码生成、协作式代理交互，用户只需用自然语言描述需求，Qoder 的代理即可自主规划任务、生成高质量代码。'
    },
    {
    ...
    {
      title: 'Devv AI | 最懂程序员的新一代 AI 搜索引擎',
      link: 'https://devv.ai/',
      desc: 'Devv AI 是一款面向开发者的智能搜索引擎和 AI 助手。它提供多种功能模式，包括 Web 模式、GitHub 模式和聊天模式。Web 模式可以搜索开发相关的最新资讯和代码片段；GitHub 模式：直接与代码库对话；聊天模式：支持使用先进的语言模型进行写作、编码等任务；专家模式：可以针对复杂的编程问题进行深入分析和解答。'
    },
    {
      title: 'Ngrok | 为容器、应用程序提供安全隧道',
      link: 'https://ngrok.com/',
      desc: 'Ngrok 是一款强大的网络隧道工具，允许开发者将本地服务暴露到外网，方便测试和演示。通过 ngrok，开发者可以为本地应用生成一个临时的公共 URL，无需配置复杂的路由和防火墙即可访问，支持 HTTPS 及 TCP 协议。它特别适合进行 Webhook 调试、第三方服务集成和实时共享本地开发环境，尤其是需要外部访问本地服务的场景。'
    },
  ]
}