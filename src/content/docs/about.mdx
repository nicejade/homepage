...
您的链接放置在 `src/configs` 目录，这是您主要需要关注的，如果您对页面样式没有额外要求。
...
由于本项目基于 Starlight， [Homepage](https://github.com/nicejade/homepage) 高度可定制，支持自定义主题、自定义 CSS 和 JS（选择您喜欢的 JS 和 CSS 框架）、自定义布局、格式化、本地化等。有关更多信息，请查阅 [Starlight 文档](https://starlight.astro.build/zh-cn/getting-started/)。
